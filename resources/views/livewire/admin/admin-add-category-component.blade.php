    ...
    <div>
        <div>
            <div class="bg-slate-200 container mt-3 md:rounded-t-lg p-5 border-b-2 border-slate-500 items-center">
                <h1 class="text-3xl font-semibold inline-block float-left p-3">Insert New Categories</h1>
            </div>
            <div class=" container md:rounded-b-lg">
                <div class="mt-5 md:m-10 md:mt-4 overflow-x-auto">
                    <form wire:submit.prevent="save" class="md:space-y-5">
                        @csrf
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-center">
                            <input class="h-20 md:w-1/3 text-2xl rounded-xl border-2 border-red-400 md:ml-5" type="hidden" wire:model="slug" id="slug">
                        </div>
