<div>
    ...
    <div>
        <div class="bg-slate-200 container mt-3 md:rounded-t-lg p-5 border-b-2 border-slate-500 items-center">
            <h1 class="text-3xl font-semibold inline-block float-left p-3">All Orders</h1>
        </div>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="flex flex-col md:flex-row md:space-x-5">
                                    <div class="w-fit mx-auto">
                                        <a href="{{ route('admin.order.detail', ['orderr' => $order->id]) }}" title="Order Details"><i class="fa fa-bars text-3xl"></i></a>
                                    </div>
                                    
                                    <div class="dropdown w-fit mx-auto">
                                        <button type="button" data-toggle="dropdown">
                                            <span class="fa fa-pencil text-3xl"></span>
                                            <span class="caret"></span>
                                        </button>
                                        <ul class="dropdown-menu -left-[140px]">
                                            <li><a href="#" wire:click.prevent="updateStatus({{$order->id}},'delivered')">Delivered</a></li>
                                            <li><a href="#" wire:click.prevent="updateStatus({{$order->id}},'canceled')">Canceled</a></li>
                                        </ul>
                                    </div>
                            </td>
                            </tr>
