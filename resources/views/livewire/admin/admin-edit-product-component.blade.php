<div>
    @if(Session::has('updateArr'))
    @dd(session('updateArr'))
    @endif
    <div>
        <div>
            <div>
                <div class="bg-slate-200 container mt-3 md:rounded-t-lg p-5 border-b-2 border-slate-500 items-center">
                    <h1 class="text-3xl font-semibold inline-block float-left p-3">Update Product</h1>
                </div>
                <div class=" container md:rounded-b-lg">
                    <div class="wrap-breadcrumb md:ml-7">
                        <ul>
                            ...
                            <li class="item-link"><span>Update Product</span></li>
                        </ul>
                    </div>
                        ...
                        <form wire:submit.prevent="save" method="post" class="items-center" enctype="multipart/form-data">
                            ...
                            <div class="md:space-y-5">
                                <div class="text-center">
                                    ...
                                    @error('regular_price') <span class="text-red-500 text-center inline">{{ $message }}</span> <br> @enderror
                                </div>
                                ...
                                <div class="flex flex-col md:grid md:grid-cols-2 md:items-center  md:gap-x-10">
                                    ...
                                    <input required class="h-20 md:w-2/4 text-2xl rounded-xl border-2 border-red-400" placeholder="Product Name" type="text" wire:model='name' wire:keyup="generateSlug" id="name">
                                </div>
                                <div class="flex flex-col md:grid md:grid-cols-2 md:items-center md:gap-x-10">
                                    <label for="slug" class="md:text-right">Product Slug</label>
                                    <input required class="h-20 md:w-2/4 text-2xl rounded-xl border-2 border-red-400" placeholder="Product Slug" type="text" wire:model='slug' id="slug">
                                </div>
                                <div class="flex flex-col md:grid md:grid-cols-2 md:items-center md:gap-x-10">
                                ...
                                <div class="flex flex-col md:grid md:grid-cols-2 md:items-center md:gap-x-10">
                                    ...
                                    <input class="h-20 md:w-2/4 text-2xl rounded-xl border-2 border-red-400" placeholder="Sale Price" type="number" id="sale_price" wire:model="sale_price">
                                </div>
                                <div class="flex flex-col md:grid md:grid-cols-2 md:items-center md:gap-x-10">
                                ...
                                <div class="flex flex-col md:grid md:grid-cols-2 md:items-center md:gap-x-10">
                                    ...
                                    <div class="my-10">
                                        <img class="" src="{{ $newImage->temporaryUrl() }}" alt="" height="250" width="250">
                                    </div>
                                    @else
                                    <div class="my-10">
                                        <img class="" src="{{ asset('assets/images/products') }}/{{ $image }}" alt="" height="250" width="250">
                                    </div>
                                    @endif
                                </div>
                                <div class="flex flex-col md:grid md:grid-cols-2 md:items-center md:gap-x-10">
                                ...
                                <div class="md:flex md:justify-center mt-5">
                                    <button class="p-5 px-7 bg-red-500 text-white rounded-lg mt-3" type="submit" id="btn-submit">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
