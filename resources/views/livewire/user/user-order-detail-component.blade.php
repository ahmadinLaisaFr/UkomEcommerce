    ...
    <div class="my-10">
        <div class="bg-slate-200 container mt-3 md:rounded-t-lg p-5 border-b-2 border-slate-500 items-center">
            ...
            <div class="float-right">
                <a href="{{ route('user.orders')}}" class="p-3 bg-green-500 text-white text-2xl inline-block rounded-lg hover:text-slate-200 hover:bg-green-700 mr-3" >My Orders</a>
                <a href="#" onclick="return confirm('Are you sure you want to cancel?') || event.stopImmediatePropagation()" wire:click.prevent="updateStatus({{ $order->id }}, 'canceled')" class="p-3 bg-red-500 text-white text-2xl inline-block rounded-lg hover:text-slate-200 hover:bg-red-700 focus:text-slate-200">Cancel Order</a>
            </div>
            <div class="clear-both"></div>
            {{-- pesan sukses dan error --}}
            @if(session()->has('success'))
            <div class="bg-green-500 p-5 rounded-lg items-center mt-3">
            ...
            <div class="bg-red-500 p-5 rounded-lg items-center mt-3">
