		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span class="link">product category</span></li>
					<li class="item-link"><a href="{{ route('product.category', ['slug' => $category->slug]) }}">{{ $category->name }}</a></li>
				</ul>
			</div>
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="wrap-shop-control">
						...
						<h1 class="shop-title">Category : {{ $category->name }}</h1>
